...
`.trim();
    ...
    if (sampled) {
      ...
      void logBotEvent({
        ...
        scoreBand: typeof metaAny.scoreBand === "string" ? (metaAny.scoreBand as string) : undefined,
        ...
        intent: meta.intent,
        segment: typeof metaAny.segment === "string" ? (metaAny.segment as string) : undefined,
        scale: typeof metaAny.scale === "string" ? (metaAny.scale as string) : undefined,
        timeline: typeof metaAny.timeline === "string" ? (metaAny.timeline as string) : undefined,
