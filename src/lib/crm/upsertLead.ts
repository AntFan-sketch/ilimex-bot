  ...
  if (input.conversationId) {
    const result = await pool.query(
      ...
      DO UPDATE SET
        ...
        deal_stage = COALESCE(EXCLUDED.deal_stage, crm_leads.deal_stage),
        next_action = COALESCE(EXCLUDED.next_action, crm_leads.next_action),
        next_action_priority = COALESCE(EXCLUDED.next_action_priority, crm_leads.next_action_priority),
